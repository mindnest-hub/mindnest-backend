...
var UserController = function () {
    ...
    var _updateProgress_decorators;
        ...
        UserController_1.prototype.getProfile = function (req) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    ...
                    return [2 /*return*/, this.userService.findOne(req.user.userId)];
                });
            });
        };
        UserController_1.prototype.updateProgress = function (req, body) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.userService.updateProgress(req.user.userId, body)];
                });
            });
        };
    ...
    (function () {
        ...
        _updateProgress_decorators = [(0, common_1.UseGuards)((0, passport_1.AuthGuard)('jwt')), (0, common_1.Patch)('progress')];
        ...
        __esDecorate(_classThis, null, _updateProgress_decorators, { kind: "method", name: "updateProgress", static: false, private: false, access: { has: function (obj) { return "updateProgress" in obj; }, get: function (obj) { return obj.updateProgress; } }, metadata: _metadata }, null, _instanceExtraInitializers);
